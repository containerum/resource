...
type DeployActions interface {
	...
	CreateDeployment(ctx context.Context, projectID, nsID string, deploy kubtypes.Deployment) (*deployment.DeploymentResource, error)
	ChangeActiveDeployment(ctx context.Context, projectID, nsID, deplName, version string) (*deployment.DeploymentResource, error)
	UpdateDeployment(ctx context.Context, projectID, nsID string, deploy kubtypes.Deployment) (*deployment.DeploymentResource, error)
	SetDeploymentReplicas(ctx context.Context, projectID, nsID, deplName string, req kubtypes.UpdateReplicas) (*deployment.DeploymentResource, error)
...
type ServiceActions interface {
	CreateService(ctx context.Context, projectID, nsID string, req kubtypes.Service) (*service.ServiceResource, error)
