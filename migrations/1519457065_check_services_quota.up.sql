...
BEGIN
  ...
  INTO max_external, max_internal, ns_id
  FROM deployments d
...
CREATE TRIGGER check_services_quota BEFORE INSERT OR UPDATE ON services
  FOR EACH ROW EXECUTE PROCEDURE check_services_quota();